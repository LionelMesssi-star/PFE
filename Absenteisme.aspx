    ...
    <form id="form1" runat="server">
        <div class="dashboard-header">
            <div class="dashboard-header-title">
                <span>Absenteisme,                    <span><%= DateTime.Now.ToString("dd/MM/yyyy HH:mm") %></span>
</span>
            </div>
        </div>
        ...
        <dx:ASPxFormLayout ID="FormEffectif" runat="server" EnableViewState="false" EncodeHtml="false" RequiredMarkDisplayMode="RequiredOnly" ColumnCount="4" Theme="Glass" Width="100%">
            <Items>
                 <dx:LayoutGroup Caption="" ColumnSpan="4" GroupBoxStyle-Caption-Font-Bold="true" Width="100%">
                    <Items>
                                        ...
                                        <tr>
                                            <td style="width: 360px;">
                                                <table class="metric-table">
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px;">Durée Absence Moyenne  </td>
                                                        <td style="width: 80px;">
                                                    ...
                                                    <tr>
                                                        <td style="height: 15px;">
                                                            <dx:ASPxLabel ID="txtAbsMoyen" Text="  " runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td class="metric-value-male">
                                                            <dx:ASPxLabel ID="txtAbsMoyenhomme" Text="" runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td style="width: 5px;"></td>
                                                        <td class="metric-value-female">
                                                            <dx:ASPxLabel ID="txtAbsMoyenFamme" Text="ans" runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td style="width: 10px;"></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <td style="width: 360px;">
                                                <table class="metric-table">
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px;">Durée Absence Maximale</td>
                                                        <td style="width: 80px;">
