<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gender.aspx.cs" Inherits="Gender" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:SqlDataSource ID="SqlGender" runat="server" ConnectionString="<%$ ConnectionStrings:ErpbilansocialConnectionString %>"
                 ...
                 DeleteCommand="deleteSexe" DeleteCommandType="StoredProcedure"
                UpdateCommand="UpdateSexe" UpdateCommandType="StoredProcedure"
                InsertCommand="insertSexe" InsertCommandType="StoredProcedure">
                <DeleteParameters>
           ...
           <dx:ASPxGridView ID="GridCl" ClientInstanceName="GridCl" Theme="Office365"
            runat="server" AutoGenerateColumns="False" DataSourceID="SqlGender"
