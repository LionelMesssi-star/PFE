                                        ...
                                        <tr>
                                            <td style="width: 360px;">
                                                <table class="metric-table">
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px;">Rémunération Minimale</td>
                                                        <td style="width: 80px;">
                                                    ...
                                                    <tr>
                                                        <td style="height: 15px;">
                                                            <dx:ASPxLabel ID="txtAgeMoyen" Text=" " runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td class="metric-value-male">

                                                            <dx:ASPxLabel ID="txtRemMoyenhomme" Text="" runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td style="width: 5px;"></td>
                                                        <td class="metric-value-female">
                                                            <dx:ASPxLabel ID="txtRemMoyenFamme" Text="ans" runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td style="width: 10px;"></td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <td style="width: 360px;">
                                                <table class="metric-table">
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px;">Rémunération Maximale</td>
                                                        <td style="width: 80px;">
                                                    ...
                                                    <tr>
                                                        <td style="height: 15px;">
                                                            <dx:ASPxLabel ID="txtMax" Text=" " runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td class="metric-value-male">
                                                            <dx:ASPxLabel ID="txtMaxHomme" Text="   ans" runat="server" Theme="Aqua"></dx:ASPxLabel>
                                                        </td>
                                                        <td style="width: 5px;"></td>
                                                        <td class="metric-value-female">
